...
export class ReddahService {
  ...
  tailUp = ()=>{
    let l = new fabric.Path(this.pathNoteTailUp, {
        fill: 'none',
        stroke: 'transparent',
        strokeMiterLimit: 10,
        opacity: 1,
  ...
  tailDown = ()=>{
    let l = new fabric.Path(this.pathNoteTailDown, {
        fill: 'transparent',
        stroke: 'transparent',
        strokeMiterLimit: 10,
        opacity: 1,
  ...
  mark = (tag, path, groupId, n, pai, left1, left2, top)=>{
    let left = pai>=8?left1:left2;
