...
@Component({
    ...
    templateUrl: './chat-fire-box.component.html',
    styleUrls: ['./chat-fire-box.component.scss']
})
export class ChatFireBoxComponent implements OnInit {
...
/*
    firebaseSend(chatId, userName, type, content){
        ...
        console.log(this.db.database.app)
