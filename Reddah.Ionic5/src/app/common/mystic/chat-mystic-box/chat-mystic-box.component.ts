...
@Component({
    selector: 'app-chat-mystic-box',
    templateUrl: './chat-mystic-box.component.html',
    styleUrls: ['./chat-mystic-box.component.scss']
})
export class ChatMysticBoxComponent implements OnInit {
